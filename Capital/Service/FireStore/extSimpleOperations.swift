...
extension FireStoreData {
    ...
    func create(_ dataObject: DataObjectType, with data: [String: Any?], completion: ((String?)->())? = nil) {
    ...
    func update(_ dataObject: DataObjectType, id: String?, with values: [String: Any?], completion: (()->())? = nil) {
