...
extension FireStoreData {
    ...
    internal func create(_ dataObject: DataObjectType, with data: [String: Any?],
    ...
    internal func update(_ dataObject: DataObjectType, id: String?, with values: [String: Any?],
                completion: (() -> Void)? = nil) {
