...
//    )
    ...
    func send(_ finTransaction: FinTransaction,
...
//            let finTransaction = FinTransaction(from: from, to: to, amount: amount, date: date, approvalMode: approvalMode, recurrenceFrequency: recurrenceFrequency, recurrenceEnd: recurrenceEnd, parent: parent ?? newFinTransactionRef.documentID)
//            return send(finTransaction, to: fsTransaction, result: (approvedAmount, dynamics))
////            return sendFinTransaction(
////                to: fsTransaction,
////                from: from,
////                to: to,
...
//    }
    ...
    internal func send(_ finTransaction: FinTransaction,
        to fsTransaction: Transaction,
        result: SendFinTransactionResult = (0, [Date: Int]())) -> SendFinTransactionResult {
        guard
            let newFinTransactionRef = self.ref?.collection(DataObjectType.transaction.rawValue).document(),
