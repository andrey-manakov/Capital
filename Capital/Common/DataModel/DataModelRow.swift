...
protocol DataModelRowProtocol: BasicDataPropertiesProtocol {
    ...
    var selectAction: ((_ row: DataModelRowProtocol, _ ix: IndexPath) -> ())? {get set}
...
struct DataModelRow: DataModelRowProtocol {
    ...
    var height: CGFloat?
    var style: CellStyle?
    var selectAction: ((_ row: DataModelRowProtocol, _ ix: IndexPath) -> ())?
    var accessory: Int?
    var filter: Any?
    ...
    init(id: String? = nil, name: String? = nil, desc: String? = nil, height: CGFloat? = nil, left: String? = nil, up: String? = nil, down: String? = nil, right: String? = nil, style: CellStyle? = nil, action: ((_ row: DataModelRowProtocol, _ ix: IndexPath)->())? = nil, accessory: Int? = nil, filter: Any? = nil) {
        self.id = id
        self.name = name
        self.desc = desc
        self.height = height
...
extension DataModelRow: Equatable {
    static func == (lhs: DataModelRow, rhs: DataModelRow) -> Bool {
        ...
        //FIXME: function and any comparison
    }
