...
protocol ViewControllerProtocol: class {
    ...
    func dimissNavigationViewController(completion: (()->())?)
...
class ViewController: UIViewController, ViewControllerProtocol {
    ...
    func dimissNavigationViewController(completion: (()->())? = nil) {navigationController?.dismiss(animated: true, completion: completion)}
