...
extension AccountGroupEditVC {
    class Service: ClassService {
        ...
        func getData(forId id: String? = nil, completion: @escaping ((DataModelProtocol) -> ())) {
        ...
        func rowSelected(id: String?, completion: ((DataModelProtocol) -> ())? = nil) {
        ...
        func didTapDone(name: String?, completion: (()->())? = nil) {
