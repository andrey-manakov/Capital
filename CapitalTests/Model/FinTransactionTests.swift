...
class FinTransactionTests: XCTestCase {
    ...
    func testDescription() {
        ...
        XCTAssert(transaction.description == "from: account1 to: account2 amount: 10 date: \(currentDate.str)")
        XCTAssert(transaction.debugDescription == "from: account1 to: account2 amount: 10 date: \(currentDate.str)")
    }
